...
- Some basic level of understanding about Python or programming tools such as R and others. 
  ...
  - If you are coming from primarily Excel background and have little experiences in programming-based solutions, please start with ["Excel and Python - A Tale of Two Power Tools"](ExcelPython.qmd). As it transitions you nicely from spreadsheet environment to programming environment.
