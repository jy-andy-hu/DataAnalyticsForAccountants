...
2. Microsoft Excel (Microsoft 365 version) with personal microsoft account signed in. (see [how-to](/chapters/Setup-anacondacode.qmd))

    - Preferrably desktop app
    
    - Alternatively, Excel Online (via Microsoft Account, see "2" in the linked setup guide)
...
3. Anaconda Code and Anaconda Toolbox with an Anaconda Account signed in  (see [how-to](/chapters/Setup-anacondacode.qmd))
