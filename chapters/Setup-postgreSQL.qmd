...
PostgreSQL is a powerful, open source object-relational database system. It is free for personal use. It is also available across many different platforms including Windows, macOS and Linux. This guide is written on Windows OS. Installation on macOS should follow similar settings.
...
5. Once admin tool is open, expand on "Servers" list and open the default server, here it is called "PostgreSQL 17". You will be prompted to enter the same password (**PostSQL1234**) that we setup earlier.
